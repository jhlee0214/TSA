...
let TasksController = class TasksController {
    ...
    async updateTask(id, updateTaskDto) {
        common_1.Logger.log(`Replacing task with id ${id}...`, 'TasksController');
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('status', new common_1.ParseEnumPipe(client_1.Status, { optional: true }))),
